...
# Code blocks may be returned by functions, but firt they must be converted into
...
# Call n_times an store its return in a variable
# (|n| 23 * n)
puts
p1 = n_times 23
puts p1.class
...
# Call day_of_week and store its return in a varibale.
d = day_of_week
